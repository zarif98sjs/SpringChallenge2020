...
//                            }
        ...
        for(auto en:enPacsNow)
        {
            ...
            for(auto me:myPacsNow)
            {
                if(isPacInDanger(me.r,me.c,en.r,en.c,me.type,en.type)!="-1")
                    continue;
            ...
            if(min_d_id!=-1) vpell[min_d_id].push_back(Pellet(en.r,en.c,5,min_d));
        }
