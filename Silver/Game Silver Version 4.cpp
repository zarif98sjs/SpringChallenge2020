...
int main()
{
    ...
    while (1)
    {
        ...
        for (int i = 0; i < visiblePacCount; i++)
        {
            ...
            if(mine)
                cerr<<pacId<<" : "<<speedTurnsLeft<<" "<<abilityCooldown<<endl;
            cin.ignore();
...
//        }
        ...
        for(auto en:enPacsNow)
        {
            for(auto me:myPacsNow)
            {
                ...
                vpell[me.id].push_back(Pellet(en.r,en.c,-1,distance));
            }
        }
...
//        }
        ...
        for(auto myPac:myPacsNow)
        {
            ...
            if(isDanger) go_id = vpell[myPac.id].size()-1;
